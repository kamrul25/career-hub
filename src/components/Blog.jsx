          ...
          <div className="grid grid-cols-1 gap-16  lg:grid-cols-2">
            <div className="rounded-lg shadow-md p-3 hover:border-2">
              ...
              <p className="text-gray-700">
                ...
                updated with the new theme. If I build my own router, I might
                want to know whether it’s active or not that time I will use it.
                Also when need to manage complex state I will use it.
              </p>
            </div>
            ...
            <div className="rounded-lg shadow-md p-3 hover:border-2">
              ...
              <p className="text-gray-700">
                ...
                writing the same code across multiple components that use the
                same common stateful logic (say a “setState” or localStorage
                logic), you can put that code inside a custom hook and reuse it.
              </p>
            </div>
            ...
            <div className="rounded-lg shadow-md p-3 hover:border-2">
              ...
              <p className="text-gray-700">
                ...
                The useMemo Hook allows me to memoize expensive functions so
                that I can avoid calling them on every render. I simple pass in
                a function and an array of inputs and useMemo will only
